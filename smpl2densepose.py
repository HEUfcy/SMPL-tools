...
def smpl2jpg():
    ...
    # 读取 pickle 文件
    with open('./motion/ep000010/test1.json.pkl', 'rb') as f:
        data = pickle.load(f)
    ...
    image_dir = './smpl2densepose/png'  # 设置保存图片的目录
    video_dir = './smpl2densepose/videos'  # 设置生成视频的目录
